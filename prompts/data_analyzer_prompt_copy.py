...
5. **Save Plots Correctly**
   - If you are asked to generate or your solution generates an image, make sure you always create the image as output.png and save 
   it in working directory (working_dir).
